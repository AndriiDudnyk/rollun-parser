    ...
    public function __invoke()
    {
        return [
            'dependencies' => [
                ...
                'factories' => [
                    ProxySystem::class => ProxySystemFactory::class,
            ...
            ProxySystemFactory::class => [
                ProxySystemFactory::KEY_LOADER_TASK_DATASTORE => LoaderTaskInterface::class,
                ProxySystemFactory::KEY_PROXY_DATASTORE => __NAMESPACE__ . 'proxyDataStoreAutoGeneratedId',
                ProxySystemFactory::KEY_PROXY_LIST_URI => 'https://free-proxy-list.net/',
                ProxySystemFactory::KEY_LOADER_TASK_OPTIONS => [
